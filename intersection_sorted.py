...
def intersection_sorted(R_file, S_file, output_file="RintersectionS.tsv"):
    """Υλοποίηση της Τομής μεταξύ δύο ταξινομημένων αρχείων."""
...
def main():
    ...
    if len(args) < 2 or len(args) > 3:
        print("Usage: python intersection_sorted.py <R_file> <S_file> [output_file]")
        sys.exit(1)
